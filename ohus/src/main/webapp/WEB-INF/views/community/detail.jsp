...
<div class="page-main">
	...
	<div class="content-main">
		...
		<div class="align-center">
			<img src="${pageContext.request.contextPath}/upload/${board.cboard_photo1}" class="detail-img">
		</div>
		</c:if>
		<c:if test="${!empty board.cboard_photo2}">
		<div class="align-center">
			<img src="${pageContext.request.contextPath}/upload/${board.cboard_photo2}" class="detail-img">
		</div>
		</c:if>
		<p>
			${board.cboard_content}
		</p>
		<hr size="1" noshade="noshade" width="100%">
		<ul class="detail-sub">
			<li>
			...
			<li>
				...
				최근 수정일 : ${board.cboard_modifydate}
				</c:if>
				작성일 : ${board.cboard_regdate}
				<%-- 로그인한 회원번호와 작성자 회원번호가 
				     일치해야 수정,삭제 가능 --%>
				<c:if test="${user_num == board.mem_num}">
				<input type="button" value="수정" 
				  onclick="location.href='updateForm.do?cboard_num=${board.cboard_num}'">
		...
		<div id="reply_div">
			...
			<form id="re_form">
				<input type="hidden" name="cboard_num"
				   value="${board.cboard_num}" id="cboard_num">
