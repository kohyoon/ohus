...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/lss/list.css">
<script type="text/javascript">
	$(function() {
...
<body>
		...
		<!-- 내용 시작 -->
			...
			<div class="result-display" style="color: #424242";>전체 ${count}
			</div>
			<div class="page-main">
					...
					<c:if test="${count > 0}">
						...
						<c:forEach var="board" items="${list}">
							<div class="community">
								...
								<a
									href="${pageContext.request.contextPath}/community/detail.do?cboard_num=${board.cboard_num}">
									<img
									src="${pageContext.request.contextPath}/upload/${board.cboard_photo1}"
									class="photo1">
								</a>
								<div class="community-center"
									style="font-weight: bold; font-size: 16px;">${board.cboard_title}</div>
