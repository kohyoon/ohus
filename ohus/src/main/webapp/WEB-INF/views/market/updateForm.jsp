		...
		<form id="update_form" action="update.do" method="post" enctype="multipart/form-data">
			...
			<ul>
				...
				<li>
					...
					<textarea rows="5" cols="30" name="market_content" id="content" maxlength="50">${market.market_content}</textarea>
				</li>
				<li>
				...
				<li>
					...
					<img id="photo1_preview" src="${pageContext.request.contextPath}/upload/${market.market_photo1}">
				</li>
				<li>
					<label for="market_photo2">두번째 사진</label>
					<input type="file" name="market_photo2" id="photo2" accept="image/gif,image/png,image/jpeg">
					<img id="photo2_preview" src="${pageContext.request.contextPath}/upload/${market.market_photo2}">
				</li>
			</ul> 
