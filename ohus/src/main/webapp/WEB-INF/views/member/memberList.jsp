...
<body>
	<div class="page-main">
		...
		<div class="content-main">
			<h2>회원 목록(관리자 전용)</h2>
			<!--  검색창 시작 --> 
			<form id="search_form" action="memberList.do" method="get"> <%-- 자기 자신, 이 jsp파일을 호출함 --%>
			<ul class="search">
				<li>
			...
			<div class="list-space align-right">
				...
				<input type="button" value="목록" onclick="location.href='memberList.do'"> <!-- 목록에서 목록 넣는 이유 -->
			...
			<c:if test="${count>0 }"> <!-- 목록이 있는 경우. 테이블로 작업하자 -->
				<table>
					<!-- 항목 -->
					<tr>
						<th>아이디</th>
