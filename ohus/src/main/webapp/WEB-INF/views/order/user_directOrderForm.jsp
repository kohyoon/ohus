...
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/sys/user_orderForm.css">
...
<div>
	...
	<div class = "content-main">
			...
			<tr>
				<td>
					<a href = "${pageContext.request.contextPath}/item/detail.do?item_num=${item.item_num}">
						<img src = "${pageContext.request.contextPath}/upload/${item.item_photo1}" width = "80">
						${item.item_name}
					</a>
				</td>
				<td class = "align-center">
					<fmt:formatNumber value = "${order_quantity}"/>
				</td>
				<td class = "align-center">
		...
		<form id = "order_form" action = "directOrder.do" method = "post">
			...
			<ul>
				...
				<li>
					...
					<input type = "text" name = "order_zipcode" id = "zipcode" maxlength = "5">
				...
				<li>
					...
					<textarea rows="5" cols="30" name = "order_notice" id = "order_notice" maxlength = "1300"></textarea>
				</li>
			</ul>
